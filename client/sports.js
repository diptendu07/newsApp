...
document.addEventListener('DOMContentLoaded', () => {    
    fetchAndRender('http://localhost:5000/api/sports/', 'sports-container');
    fetchImagesForSlider('http://localhost:5000/api/sports/', 'slider-container'); // Fetch images for the slider    
});
